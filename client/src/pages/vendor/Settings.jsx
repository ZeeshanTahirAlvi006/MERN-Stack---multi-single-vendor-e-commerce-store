...
const Settings = () => {
  ...
  const inputClasses =
    'w-full bg-transparent border-none outline-none text-[0.925rem] text-slate-900 placeholder:text-slate-300 font-[inherit] h-full';
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className={`${inputWrapperBase} border-slate-200 bg-slate-50/50`}>
                ...
                <input
                  ...
                  className={`${inputClasses} text-slate-500 cursor-not-allowed`}
                />
              </div>
              <p className="text-xs text-slate-400 mt-1">Email address cannot be changed currently.</p>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-6 flex items-center justify-center gap-2 w-full sm:w-auto px-8 h-12 bg-blue-800 text-white rounded-full text-[0.95rem] font-semibold cursor-pointer transition-all duration-300 hover:not-disabled:bg-blue-700 hover:not-disabled:shadow-md hover:not-disabled:shadow-blue-800/25 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {loading ? (
